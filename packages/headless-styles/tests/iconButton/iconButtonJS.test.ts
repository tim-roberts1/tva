import { getJSDangerIconButtonProps, getJSIconButtonProps } from '../../src'
...
describe('JS Icon Button', () => {
  ...
  describe('getJSDangerIconButtonProps', () => {
    const baseOptions = {
      ariaLabel: 'JS Danger Icon Button',
    }

    test('should accept an ariaLabel prop', () => {
      const iconButtonReturn = getJSDangerIconButtonProps(baseOptions)
      expect(iconButtonReturn.button.cssProps).not.toHaveLength(0)
      expect(iconButtonReturn.button.styles).toBeDefined()
      expect(iconButtonReturn.button.type).toEqual('button')
      expect(iconButtonReturn.iconOptions).toBeDefined()
      expect(iconButtonReturn.button['aria-label']).toEqual(
        'JS Danger Icon Button'
      )
    })

    test('should accept a text kind type', () => {
      const iconButtonReturn = getJSDangerIconButtonProps({
        ...baseOptions,
        kind: 'text',
      })
