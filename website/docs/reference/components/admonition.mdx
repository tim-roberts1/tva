...
To use an admonition with a close button, add in an IconButton.
...
- `sentiment`: A String value of a theme sentiment `'info' | 'success' | 'warning' | 'danger'` which determines the styling color theme produced.
