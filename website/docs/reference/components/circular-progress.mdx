...
Circular Progress **should not be used for initial page loading**. Check out the [Learn Pando: Page Loading](../../learn/learn-pando/design-patterns/page-loading.mdx) lesson for more information.
...
```typescript
getCircularProps(options?: CircularOptions)
```
...
**Don't** use text or other elments within the Circular Progress.
