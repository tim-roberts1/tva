...
2. A button properity containing an of the a11y properties and a className list which includes an unused class consisting of the naming pattern `pando-alert-cancel`.
...
1. A buttonOptions property containing the preset options for the Button API.
2. A button properity containing an of the a11y properties and a className list which includes an unused class consisting of the naming pattern `pando-alert-confirm`.
