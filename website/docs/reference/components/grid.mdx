...
Here is an example of how columns work with the Grid. Here we are creating a 12 column grid with a gap of 32px between each column.
...
Here is an example of how to span columns with the GridItem. Here we are creating a 12 column grid with a gap of 32px between each column. We are also spanning the first GridItem to take up 4 columns.
...
Here is an example of how to use template areas with the Grid. Here we are creating a 12 column grid with a gap of 32px between each column. We are also using the `areas` property to define the layout of the GridItems. This is a great way to create responsive layouts.
