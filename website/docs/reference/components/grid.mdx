...
1. An Object matching the [Anatomy](#anatomy) containing `className` and a11y properties relevant to the Grid element including an unused class conisting of the naming pattern `pando-grid-item`.
2. A `style` property that adds dynamic styling based on the options provided.
