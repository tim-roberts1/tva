...
1. An Object matching the [Anatomy](#anatomy) containing `className` and a11y properties relevant to each element/section including an unused class conisting of the naming pattern `pando-badge`.
