...
Pando comes built in with themes which is the foundation of our UI Kit. We utilize a semantic naming convention to help associate colors that is both functional and scales successfully.
...
With this naming convention, you can easily use tokens based on their functionality following the naming structure:
...
Most our colors in the theme won't include this category, but in some cases, you will need them:
