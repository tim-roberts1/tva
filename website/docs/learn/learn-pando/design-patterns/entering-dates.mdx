...
In Pando, we recommend using the text-based Input combined with the [useAutoFormatdate](../../../reference/react-hooks/useAutoFormatDate.mdx) hook for displaying a way to entering a date.
