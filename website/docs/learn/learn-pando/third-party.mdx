...
Additionally, our Style Objects use the common nested pattern that is accepted by most libraries. You will need to validate what rules the integration you plan on using has to ensure you will not need to update the data.
