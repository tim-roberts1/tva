...
<LiveExampleTabs
  examples={{
    react: 'TODO: FIGURE OUT HOW TO GET BLOCK IN HERE',
    styled: 'external link to sandbox',
    joy: 'external link to sandbox',
    chakra: 'external link to sandbox',
    svelte: 'external link to sandbox',
  }}
/>
