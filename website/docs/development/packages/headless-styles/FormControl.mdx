...
`getFormErrorMessageProps` will return a styled error messaged when the `invalid` option is true (this should come from the `getFormControlProps.fieldOptions` property).
