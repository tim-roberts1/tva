...
| ------------------ | ------------------------------------------ | ------------------ | ------------------------------------- |
| `getSwitchProps`   | **options**: [BadgeOptions](#badgeoptions) | **kind**: 'strong' | Get badge styles for CSS usage.       |
| `getJSSwitchProps` | **options**: [BadgeOptions](#badgeoptions) | **kind**: 'strong' | Get badge styles for CSS in JS usage. |
