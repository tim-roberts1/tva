...
This ensures the icon color matches its context by default and facilitates theming while still allowing for control over the icon's color directly.
...
function MyPlayComponent (props) {
  return(
    {/*
