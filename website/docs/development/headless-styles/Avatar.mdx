...
If a profile image is available, it should be used as the content for the avatar.

#### Initials (fallback)

In the absence of a profile image, the person's initials (up to 2 characters) should be displayed.

#### Icon (fallback - last resort)
