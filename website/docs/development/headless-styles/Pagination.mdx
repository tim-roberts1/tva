...
For an approach that allows filering, page naviation, and text information, use the `getPaginationProps` helper with the `cols` option set to the amount of information you would like to display.
