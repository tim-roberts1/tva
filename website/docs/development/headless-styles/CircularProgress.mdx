...
Circular Progress **should not be used for initial page loading**. This API is meant for action-based responses that usually require a fetch call. For page loading, use the [Skeleton API](./Skeleton).
