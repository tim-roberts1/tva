...
<!-- TODO: Add visual example here -->

```jsx
<BriefcaseIcon {...getIconProps({ ariaHidden: true })} />
```
...
```jsx
<VolumeOffIcon {...getIconProps({ label: 'Volume is off' })} />
```
...
| `getJSIconProps` | **options**: [IconOptions](#iconoptions) | **size**: 'm' | CSS-in-JS API         |
