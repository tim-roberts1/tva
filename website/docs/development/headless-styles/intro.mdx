...
Headless Styles relies upon the use of our **fonts and normalize setup**. Please see the [installation guide](../getting-started/installation) for more information.
