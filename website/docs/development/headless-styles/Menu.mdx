...
```javascript
import { UNSAFE_getMenuProps } from '@pluralsight/headless-styles'
```
...
| ----------------------- | ---------------------------------------- | --------------- | -------------------- |
| `UNSAFE_getMenuProps`   | **options**: [MenuOptions](#menuoptions) |                 | Get main menu styles |
| `UNSAFE_getJSMenuProps` | **options**: [MenuOptions](#menuoptions) | same as CSS API | CSS-in-JS API        |
