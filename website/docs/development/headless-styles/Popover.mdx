...
A popover is a non-modal [dialog](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles/dialog_role) for displaying contextual information when an element is interacted with.
