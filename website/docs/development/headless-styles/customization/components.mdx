...
Headless Styles relies on our [Normalize Setup](../../getting-started/installation.md#normalizecss) and uses the Design Token theme under the hood. This is why whether you use the JS API or our default CSS API, themeing automagically "just works".
...
In fact, we encourage everyone to at least try out using the native API for a few months before adding in 3rd party UI library. You may be surprised at how easy and **more flexible** it is than using libraries like MUI, etc.
