---
tags: [Development, Packages, Components, Headless Styles, Table]
---
...
<ViewSourceLink
  icon="github"
  href="https://github.com/pluralsight/tva/tree/main/packages/headless-styles/src/components/Table"
>
  View source
</ViewSourceLink>
...
import type { TableOptions } from '@pluralsight/headless-styles/types'
```
