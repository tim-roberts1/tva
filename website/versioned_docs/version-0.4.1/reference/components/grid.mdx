...
- `options`: A Number value for properties cols and rows which determine the grid layout axes. A Number value for the property gap of `6 | 8 | 12 | 16 | 32` which determines the gap size for the grid.
