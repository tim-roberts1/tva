...
For **bold** text, wrap your text in a [`strong`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/strong) element if the contents has importance, or [`b`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/b) element if you just need to bring attention to something.
