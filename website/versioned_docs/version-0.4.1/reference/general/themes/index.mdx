...
Accessibility is our highest priority with Pando, which means all of our themes are visually accessible by default. **This means that our themes are both contrast- and colorblind-friendly.**
...
### How visually prominent should the color be?
...
- **Focus:** The indicator (visual, aural, or otherwise) that an element is currently selected and can be interacted with
