...
Want to create a more performant pattern? Go ahead and create a new component in the StarRating file called `StarButton` and you can move the button contents into that! Now you have more single responsibility components!
