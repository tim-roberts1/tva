...
This is useful when navigating ordered content, such as comments or course listings.

### Pagination Bar

The Pagination Bar expands on the Modern aproach, offering more information and control. This approach adds controls for the page size (number of items displayed) and indicates the size of the list, along with the user's position within that list.
